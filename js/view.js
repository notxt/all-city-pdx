...
var _El_container;
import { createHome } from "./location/home.js";
import { createKillingsworth } from "./location/killingsworth.js";
...
export const createView = (game) => {
    ...
    const locationMap = {
        "Home Sweet Home": createHome(createLocation),
        Killingsworth: createKillingsworth(createLocation),
    };
    game.watch.move((state) => {
        el.setContent(locationMap[state.hero.location]);
    });
    return el;
};
